        ...
        if cy <= gestureThreshold:  # If hand is at the height of the face
            if fingers == [1, 0, 0, 0, 0]:
                ...
                if imgNumber > 0:
                    ...
                    cv2.putText(imgCurrent,'Oops, it is FIRST SLIDE',(20,40),fontFace=cv2.FONT_HERSHEY_SIMPLEX,fontScale=2,color=(256,0,0),lineType=cv2.LINE_AA,thickness=2)
            if fingers == [0, 0, 0, 0, 1]:
                ...
                if imgNumber < len(pathImages) - 1:
                    ...
                    cv2.putText(imgCurrent,'Oops, it is LAST SLIDE',(20,40),fontFace=cv2.FONT_HERSHEY_SIMPLEX,fontScale=2,color=(256,0,0),lineType=cv2.LINE_AA,thickness=2)
